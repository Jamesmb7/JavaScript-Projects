...
const Calculator = 
{
    ...
    First_Operand: null,
    //This checks wether or not th second operand has been inputted by the user. 
    Wait_Second_Operand: false,
    //This will hold the operator, we set it to null for now.
    operator: null,
}; //what dictates the need for ";" after a function is closed? <-----
...
function Handle_Operator(Next_Operator)
{
    ...
    else if (operator)
    {
        ...
        //If operator exists, property lookup is performed from the operator
